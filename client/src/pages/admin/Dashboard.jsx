import { ChartLineIcon, CircleDollarSignIcon, Loader, StarIcon, UserIcon } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const dashboardCards = [
    ...
    {title: "Active Shows", value: dashboardData.activeShows.length || "0", icon:ChartLineIcon},
    ...
    <>
      ...
      <div className='relative flex flex-wrap gap-6 mt-4 max-w-6xl'>
        ...
        {dashboardData.activeShows.map((show)=>(
          <div key={show._id} className='w-50 rounded-lg overflow-hidden h-full pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1 transition duration-300'>
